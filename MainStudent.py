...
def studentmanagement():
	...
	if(x==1):
		...
		if(studentnew in studentlist):
			...
			print("_ New Student {} Added Successfully ++\n".format(studentnew))
			for students in studentlist:
				print("_ {} ".format(students))
		...
		if(studentsearching in studentlist):
			print("\n++ _ {} ".format(studentsearching))
		else:
			print("\n _ There is No Record Found Of this Student {} _".format(studentsearching))
...
# Fon de programme (Not finished yet)
# By Amine Slimani